...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // data-[state=closed]:pointer-events-none : si Radix Presence ne
        // démonte pas le nœud à temps après l'animation de sortie,
        // l'overlay ne doit jamais bloquer les clics sur le reste de la
        // page (bug constaté en conditions réelles : ADMIN-G02).
